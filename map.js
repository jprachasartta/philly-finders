...
JF.initialize({ apiKey: "f91bbeb58da3771327d2396a5469a757" }); //PUT YOUR OWN KEY HERE
 
// get form submissions from JotForm Format: (formID, callback)
JF.getFormSubmissions("223094876611056", function (response) {
...
const deckgl = new deck.DeckGL({
    ...
    mapboxApiAccessToken: "pk.eyJ1IjoianByYWMiLCJhIjoiY2t2aXRzOGx6Y3BldzJvbW50NGxyMDUwbSJ9.xPknrw_XSeNgZ5w7SxkOIg",
    // Set your Mapbox style here
    mapStyle: "mapbox://styles/jprac/cl9vriycd000314o80svl28s1",
    initialViewState: {
      latitude: 42.36476,
      longitude: -71.10326,
      zoom: 12,
